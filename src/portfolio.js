...
const greeting = {
  ...
  username: "Wes Devore",
  title: "Hi, I'm Wes",
  subTitle: emoji("A passionate Full Stack Software Developer 🚀 with experience developing applications using Python / Django / JavaScript / Reactjs / Nodejs / React Native and some other cool libraries and frameworks."),
  resumeLink: "https://drive.google.com/file/d/1abCLBvuT_HB6c3hVQQfQ9tr3LgBOwES8/view?usp=sharing"
};
...
const skillsSection = {
  ...
  skills: [
    ...
    emoji("⚡ Design beautiful interactive, logical and engaging user interfaces"),
...
const bigProjects = {
  ...
  projectCards: [
    {
      title: "Twitter-Clone",
      subtitle: "Fully functioning Twitter-like social network with database.",
      image: require("./assets/images/twitterBirdLogo.png"),
      footerLink: [
        { name: "Live", url: "https://stark-hamlet-51192.herokuapp.com/" },
        { name: "GitHub", url: "https://github.com/GuruComposer/twitter-clone" },
      ]
    },
    {
      title: "Gmail-Clone",
    ...
    },
    {
      ...
      subtitle: "A simple Todo list application I made using React.js.",
      image: require("./assets/images/todoListLogo.png"),
      footerLink: [
        { name: "Live", url: "https://gurucomposer.github.io/react-ToDoList/" },
        { name: "GitHub", url: "https://github.com/GuruComposer/react-ToDoList" },
      ]
    }
  ]
};
  ...
  achievementsCards: [
    {
      ...
      subtitle: "Twitter-like social network website for making posts, editing posts, liking posts, following/ unfollowing users. All actions are saved to PostgreSQL database. Main technologies used: Python, Django, Javascript, JQuery, HTML, CSS.",
